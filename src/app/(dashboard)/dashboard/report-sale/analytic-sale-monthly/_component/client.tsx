        ...
        <div className="flex flex-col bg-gray-50 w-full px-4 py-4 gap-4">
            ...
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>Analytic Sale Monthly</BreadcrumbItem>
                </BreadcrumbList>
            </Breadcrumb>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 px-6 py-5">
                ...
                <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
                    <Button
                        variant="outline"
                        className="items-center flex-none green border-teal-500 text-white hover:text-white disabled:opacity-100 gap-1.5"
                    >
                        Analytic Sale Monthly
