...
export const Client = () => {
    ...
    const dummyData = [
        {
            code_document: "LQMGT0011",
            name_document: "Buku",
            qty: 5,
            total_old_price: 500000,
            status: "process",
        },
    ];
    ...
    const columnListSale: ColumnDef<any>[] = [
        ...
        },
        {
            ...
            size: 150,
            cell: ({ row }) => (
                <div className="break-all">{row.original?.name_document || '-'}</div>
            ),
        },
        {
            accessorKey: "qty",
        ...
        },
        {
            ...
            header: "Total Old Price",
            size: 130,
            cell: ({ row }) => (
                <div className="break-all">{formatRupiah(row.original?.total_old_price || 0)}</div>
            ),
        },
        {
            accessorKey: "status",
    ...
    return (
        <div className="flex flex-col bg-gray-100 w-full px-4 py-4 gap-4">
            ...
            <div className="flex w-full bg-white rounded-md overflow-hidden shadow px-5 py-3 gap-10 flex-col">
                <h2 className="text-xl font-bold">Product B2B</h2>
                <div className="flex flex-col w-full gap-4">
                    <div className="flex gap-2 items-center w-full justify-between">
                        ...
                        <div className="flex items-center gap-3 w-full justify-end">
                            <Button
                                asChild
                                className="items-center flex-none h-9 blue border-sky-400/80 text-white hover:text-white disabled:opacity-100 hover:border-sky-400/80 disabled:pointer-events-auto disabled:cursor-not-allowed"
                                variant={"outline"}
                            >
                                <Link href={"/outbound/b2b/create"} className="flex items-center gap-2">
